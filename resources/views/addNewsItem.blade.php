    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('add-news-item') }}">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="description" class="col-md-4 col-form-label text-md-end">{{ __('Detail description') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="shortDescription" class="form-control @error('shortDescription') is-invalid @enderror" name="shortDescription" required autocomplete="shortDescription" autofocus>{{ old('shortDescription') }}</textarea>
